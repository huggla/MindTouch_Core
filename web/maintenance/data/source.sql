...
INSERT INTO `services` (`service_type`, `service_sid`, `service_description`, `service_enabled`) VALUES
	...
	('ext', 'sid://mindtouch.com/ext/2009/12/anychart', 'MindTouch Charts', 0),
	('ext', 'sid://mindtouch.com/ext/2009/12/anygantt', 'MindTouch Gantt Charts', 0),
	('ext', 'sid://mindtouch.com/std/2009/04/activitystream', 'Activity Stream', 0),
	('ext', 'sid://mindtouch.com/ext/2010/06/analytics.search', 'Curation Analytics (Search)', 0),
	('ext', 'sid://mindtouch.com/ext/2010/06/analytics.content', 'Curation Analytics (Content)', 0);
